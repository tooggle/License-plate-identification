...
def carnumber(pretrained=True, channels=3, classes=70, autoshape=True):
    return create('carnumber', pretrained, channels, classes, autoshape)



if __name__ == '__main__':
    model = custom(path_or_model='carnumber.pt')  # custom example
    # model = create(name='yolov7', pretrained=True, channels=3, classes=80, autoshape=True)  # pretrained example
    # model = create(name='carnumber', pretrained=True, channels=3, classes=70, autoshape=True
    # Verify inference
    import numpy as np
